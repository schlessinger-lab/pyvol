...
The next few section describe the parameters controlling Basic Usage, :ref:`pocket_specification:Pocket Specification`, :ref:`partitioning:Partitioning Options`, and :ref:`display:Display and Output Options` along with the corresponding GUI sections.
