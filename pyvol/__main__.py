...
def main():
    parser = argparse.ArgumentParser(prog="PyVOL", description="Identification, calculation, and segmentation of protein binding pockets", epilog="For complete documentation and tutorials on use, visit the project webpage: https://schlessingerlab.github.io/pyvol")
